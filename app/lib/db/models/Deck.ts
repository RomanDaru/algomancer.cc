...
export const DeckModel = mongoose.models.Deck || mongoose.model<DeckDocument>('Deck', DeckSchema);
...
export function convertDeckToDocument(deck: Partial<DeckType>): Partial<DeckDocument> {
  return {
    name: deck.name,
    description: deck.description,
    userId: deck.userId,
