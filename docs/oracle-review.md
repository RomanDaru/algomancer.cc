...
Import bol vykonaný 2026-09-21 po úspešnom nasadení `c3888c0`: 340 kariet, 285 zvýšených rulesVersion, 174 označených deckov (119 verejných). Kontrola databázy po transakcii prešla pre všetky karty. Záloha je `backups/oracle-import-1790014662930/`. Verejný katalóg ešte držal starú cache, preto nasledujúce vydanie mení jej verziový kľúč na `oracle-approved-2026-09-21`; invalidačný tag `card-catalog` zostáva zachovaný.
